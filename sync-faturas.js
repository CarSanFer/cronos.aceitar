          ...
          body: JSON.stringify({
            ...
            messages: [{
              ...
              content: [
                ...
                { type: 'text', text: `Analisa esta fatura portuguesa e devolve APENAS JSON valido sem markdown.

Bloco cliente (apos "Exmo.(s) Senhor(es)") tem 4 linhas:
1: nome empresa/pessoa
2: nome da rua (ex: RUA JULIO DINIS)
3: numero e andar (ex: 758 - 2. DT) — junta linhas 2 e 3 para formar morada completa
4: codigo postal (XXXX-XXX) seguido da localidade
NIF aparece junto a "Contribuinte" ou "V/ Contribuinte".

Exemplo real:
linha1: APPMIND LDA.
linha2: RUA JULIO DINIS
linha3: 758 - 2. DT
linha4: 4050-321 Porto
NIF: 500343721
Resultado: cliente:"APPMIND LDA.",morada_cliente:"RUA JULIO DINIS 758 - 2. DT",cp_cliente:"4050-321",localidade_cliente:"Porto",nif_cliente:"500343721"

{"numero":"FAC AC26/XX","data_fatura":"YYYY-MM-DD","vencimento":"YYYY-MM-DD","cliente":"nome","nif_cliente":"9digitos","morada_cliente":"rua numero andar completos","cp_cliente":"XXXX-XXX","localidade_cliente":"cidade","valor":1234.56,"descricao":"servico"}

Valor=TOTAL SEM IVA. Nao encontrado=null.` }
              ]
            }]
          })
        });
